...
public class ClLoginSendTests
{
    ...
    public void RoundTrip_PreservesAllFields()
    {
        ...
        var buffer = new byte[ClLoginSend.PayloadSize];
        ...
        Assert.True(ClLoginSend.TryRead(buffer, out var packet));
    ...
    {
        var buffer = new byte[ClLoginSend.PayloadSize - 1];

        Assert.False(ClLoginSend.TryRead(buffer, out _));
    }
