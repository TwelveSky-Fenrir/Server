...
/// <summary><see cref="PackedPage" />/<see cref="PackedIndex" /> only meaningful when <see cref="Outcome" /> is <see cref="TowerUpgradeOutcome.Success" />.</summary>
...
{
    ValueTask<TowerUpgradeResult> UpgradeAsync(int characterId, Zone zone, PlayerRuntimeState state,
