...
///     (report's own explicit callout: "Aucune régène passive debout"). Per legacy tick: <c>regen = MaxLife /
///     ReturnSkillValue(sitSkill, sitGradePoints, factor 2)</c> (mana: factor 3), floor 1, clamped to the
