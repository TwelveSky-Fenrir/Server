...
/// </summary>
public sealed class GiftListHandler : IInlinePacketHandler<GiftListRequest>
{
    // Safe to share across sessions: Write() only ever reads the array, and nothing else can reach this instance.
    private static readonly GiftListResponse NoGifts = new() { Result = 0, GiftItem = new int[20] };

    public void Handle(in GiftListRequest packet, IPacketSession session)
    {
