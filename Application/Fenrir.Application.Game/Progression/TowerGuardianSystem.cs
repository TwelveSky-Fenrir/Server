...
/// <summary>
///     Drives one tower's guardian-monster lifecycle for whichever single zone hosts it (<see cref="TowerZoneIndexTable" />)
///     -- the Fenrir counterpart of the legacy per-zone-process <c>MyGame::ProcessForTower</c> (S07_MyGame01.cpp:13659-13780),
...
/// </summary>
/// <remarks>
///     Reads/writes <see cref="Fenrir.Application.Game.World.Zone.TryGetMonster" />/<see cref="Fenrir.Application.Game.World.Zone.SpawnMonster" />,
