...
/// <summary>
///     op24, CZ_IMPROVE_ITEM_SEND -- standard equipment enchant via <see cref="EnchantResolver" />. Wings,
///     costumes and stellar cores are out of scope and reply with a clean failure rather than a disconnect.
/// </summary>
/// <remarks>
///     <c>ProtectForDestroy</c> has no acquisition path yet, so <see cref="EnchantResolver.Resolve" /> is always
///     called with 0 charges and <see cref="EnchantResolver.EnchantOutcome.Protected" /> is currently unreachable.
/// </remarks>
