...
/// <summary>
///     Covers <c>Zone.ApplySkillCast</c> end-to-end (<c>AVATAR_ACTION_SEND</c> Sort=30) via the same unified action
///     wire <c>AvatarActionHandler</c> forwards for every action.
/// </summary>
