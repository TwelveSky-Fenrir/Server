...
///     zone number.
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Outgoing, Opcodes.Zone.Outgoing.GetZoneConnectUserRecv,
    ExpectedSize = 9)]
public readonly partial record struct ZcGetZoneConnectUserRecv : IOutgoingPacket
{
