...
/// </summary>
public class LegacyTickAccumulatorTests
{
    [Fact]
    public void Advance_LessThanOneLegacyTick_ReturnsZero()
    {
        var accumulator = new LegacyTickAccumulator();
    ...
    public void Advance_ExactlyOneLegacyTick_ReturnsOne()
    {
        ...
        Assert.Equal(1, accumulator.Advance(LegacyTime.LegacyTick));
    }
    ...
    public void Advance_CarriesRemainderAcrossCalls_UntilAWholeTickIsDue()
    {
        ...
        // never earlier and never later -- the anti-x10 remark on LegacyTime is exactly what this guards.
    ...
    public void Advance_ManyIrregularFrames_NeverDriftsFromWallClockRate()
    {
        ...
        var expectedTicks = (int)(totalElapsed.Ticks / LegacyTime.LegacyTick.Ticks);
