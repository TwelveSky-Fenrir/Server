...
/// </summary>
public sealed class ClFailMoveZone1SendHandler : IInlinePacketHandler<ClFailMoveZone1Send>
{
    public void Handle(in ClFailMoveZone1Send packet, IPacketSession session)
    {
