...
/// </summary>
public sealed class ClCreateAvatarSend2Handler(CharacterRepository characters)
    : IAsyncPacketHandler<ClCreateAvatarSend2>
{
    ...
    public async ValueTask HandleAsync(ClCreateAvatarSend2 packet, IPacketSession session,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            session.Send(new LcCreateAvatarRecv
            {
                Result = 0,
