...
public static class SetBonusTables
{
    private static readonly FrozenDictionary<int, SetCoefficients> CoefficientsBySetNumber =
        ...
        {
            [1] = new SetCoefficients(0f, 0f, 0f, 0f, 0.4f, 0.4f, 0f, 0f, 0f),
            [2] = new SetCoefficients(0.4f, 0.4f, 0f, 0f, 0f, 0f, 0f, 0f, 0f),
            [3] = new SetCoefficients(0f, 0.6f, 0.6f, 0.6f, 0f, 0f, 0f, 0f, 0f),
            [4] = new SetCoefficients(0.6f, 0f, 0f, 0.6f, 0f, 0f, 0f, 0f, 0f),
            [5] = new SetCoefficients(1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 0.05f, 0.05f, 0f),
            [6] = new SetCoefficients(0f, 0f, 0f, 0f, 0.4f, 0.4f, 0f, 0f, 0f),
            [7] = new SetCoefficients(0.4f, 0.4f, 0f, 0f, 0f, 0f, 0f, 0f, 0f),
            [8] = new SetCoefficients(0f, 0f, 0.4f, 0.4f, 0f, 0f, 0f, 0f, 0f),
            [9] = new SetCoefficients(0.6f, 0.6f, 0.6f, 0.6f, 0f, 0f, 0.05f, 0f, 0f),
            [10] = new SetCoefficients(1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 0.05f, 0.05f, 0.05f),
            [11] = new SetCoefficients(0f, 0f, 0f, 0f, 0.6f, 0.6f, 0f, 0f, 0f),
            [12] = new SetCoefficients(0.6f, 0.6f, 0f, 0f, 0f, 0f, 0f, 0f, 0f),
            [13] = new SetCoefficients(0f, 0.7f, 0.7f, 0.7f, 0f, 0f, 0f, 0f, 0f),
            [14] = new SetCoefficients(0.7f, 0f, 0f, 0.7f, 0f, 0f, 0f, 0f, 0f),
            [15] = new SetCoefficients(1.10f, 1.10f, 1.10f, 1.10f, 1.10f, 1.10f, 0f, 0f, 0f),
            [16] = new SetCoefficients(0f, 0f, 0f, 0f, 0.6f, 0.6f, 0f, 0f, 0f),
            [17] = new SetCoefficients(0.6f, 0.6f, 0f, 0f, 0f, 0f, 0f, 0f, 0f),
            [18] = new SetCoefficients(0f, 0f, 0.7f, 0.7f, 0f, 0f, 0f, 0f, 0f),
            [19] = new SetCoefficients(0.7f, 0.7f, 0.7f, 0.7f, 0f, 0f, 0f, 0f, 0f),
            [20] = new SetCoefficients(1.10f, 1.10f, 1.10f, 1.10f, 1.10f, 1.10f, 0.05f, 0.05f, 0.10f),
            [21] = new SetCoefficients(1.2f, 1.2f, 1.2f, 1.2f, 1.2f, 1.2f, 0.05f, 0.05f, 0f),
            [22] = new SetCoefficients(0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.1f, 0.04f, 0.04f, 0f),
            // 30 handled by GetSet30Coefficients (slot/legendary-dependent row, not a fixed one).
            [50] = new SetCoefficients(0.55f, 0.55f, 0.55f, 0.55f, 0.55f, 0.55f, 0f, 0f, 0.05f),
            [51] = new SetCoefficients(0f, 0.05f, 0.05f, 0.05f, 0f, 0f, 0.02f, 0.02f, 0f)
        }.ToFrozenDictionary();
