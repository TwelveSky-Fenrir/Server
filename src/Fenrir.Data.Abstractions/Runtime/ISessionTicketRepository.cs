...
{
    public ValueTask<MintedSessionTicketDto> CreateAsync(int accountId, int characterId, byte shardId,
        int ttlSeconds, Guid sessionToken, short accountGrade, short targetMapId, IPAddress sourceAddress,
        CancellationToken ct);

    public ValueTask<ConsumedTicketDto?> ConsumeAsync(string capability, byte expectedShardId,
