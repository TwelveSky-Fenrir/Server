...
(
    ...
    -- cited on world.StarterKitHotkeys' seed data (Migrations/Seed/world/085_starter_kit_hotkeys.sql); a
    -- starter-kit grant is never a literal zero-quantity row (see 083_starter_kit_inventory.sql: 999/999/999/10).
