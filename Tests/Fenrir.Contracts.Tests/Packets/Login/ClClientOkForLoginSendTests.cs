...
public class ClClientOkForLoginSendTests
{
    ...
    public void PayloadSize_MatchesContractConstant()
    {
        ...
        Assert.Equal(0, ClClientOkForLoginSend.PayloadSize);
    }

    [Fact]
    public void RoundTrip_EmptyPayload_AlwaysSucceeds()
    {
        Assert.True(ClClientOkForLoginSend.TryRead(ReadOnlySpan<byte>.Empty, out _));
    }
    ...
    public void RoundTrip_TrailingBytesAreIgnored()
    {
        ...
        Assert.True(ClClientOkForLoginSend.TryRead(buffer, out _));
    }
}
