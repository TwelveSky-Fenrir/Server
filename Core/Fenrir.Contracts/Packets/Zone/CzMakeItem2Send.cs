...
/// <summary>
///     CZ_MAKE_ITEM2_SEND (CLIENT.h:289) — same typedef as <see cref="CzMakeItemSend" /> (29). Guarded by
...
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Incoming, Opcodes.Zone.Incoming.MakeItem2Send, ExpectedSize = 45,
    AllowedStates = [(byte)ZoneSessionState.InWorld])]
public readonly partial record struct CzMakeItem2Send : IIncomingPacket<CzMakeItem2Send>
{
