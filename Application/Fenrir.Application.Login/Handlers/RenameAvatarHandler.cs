...
/// <summary>op19 CL_CHANGE_AVATAR_NAME_SEND — result codes forwarded verbatim from game.usp_Character_Rename (0 ok, 2 name taken/unchanged, 102 slot missing, 101 SQL error).</summary>
/// <remarks>
