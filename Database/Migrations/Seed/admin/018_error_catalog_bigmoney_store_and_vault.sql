...
-- (old usp_AccountVault_TransferBigMoneyWithCharacter, codes 50350/50351) were superseded in place by
-- Migrations/046 (CREATE OR ALTER, same procedure name, new codes 50353/50354) -- 50350/50351 are NOT
-- orphaned catalog gaps from this collision, they were reassigned to the unrelated pet-bag procedures
-- (Migrations/044_character_petbag_procs.sql) and are tracked separately (see this file's own note below).
