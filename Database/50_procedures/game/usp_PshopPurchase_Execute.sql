...
CREATE PROCEDURE game.usp_PshopPurchase_Execute
    @SellerCharacterId INT,
    @SellerContainer   TINYINT,
...
BEGIN
    ...
    DELETE FROM game.CharacterItems WHERE CharacterId = @SellerCharacterId AND Container = @SellerContainer;
    ...
    SELECT @SellerCharacterId, @SellerContainer, Slot, ItemId, Quantity, Enchant, Combine, Refine, Socket,
