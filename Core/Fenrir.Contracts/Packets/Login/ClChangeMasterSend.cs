...
/// </summary>
[FenrirPacket(FenrirServer.Login, FenrirDirection.Incoming, Opcodes.Login.Incoming.ChangeMasterSend,
    ExpectedSize = 62)]
public readonly partial record struct ClChangeMasterSend : IIncomingPacket<ClChangeMasterSend>
{
