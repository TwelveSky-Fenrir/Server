...
{
    ValueTask<CraftPetResult> ResolveFourSlotRecipeAsync(CraftPetRequest packet, Zone zone, PlayerRuntimeState state,
        int characterId, CancellationToken cancellationToken);

    ValueTask<CraftPetResult> ResolveTwoSlotRecipeAsync(CraftPetRequest packet, Zone zone, PlayerRuntimeState state,
        int characterId, CancellationToken cancellationToken);
}
    ...
    : ICraftPetService
{
        ...
        PlayerRuntimeState state, int characterId, CancellationToken cancellationToken)
    {
        ...
        return await PersistAndBuildResultAsync(zone, characterId, working, resolved, newPet, 10000,
            cancellationToken);
    }
        ...
        PlayerRuntimeState state, int characterId, CancellationToken cancellationToken)
    {
        ...
        return await PersistAndBuildResultAsync(zone, characterId, working, resolved, newPet, 0, cancellationToken);
    }

    private async ValueTask<CraftPetResult> PersistAndBuildResultAsync(Zone zone, int characterId,
