...
(
    Id                TINYINT      NOT NULL CONSTRAINT DF_HeroRankingRolloverState_Id DEFAULT 1,
    LastRolloverAtUtc DATETIME2(3) NOT NULL CONSTRAINT DF_HeroRankingRolloverState_LastRolloverAtUtc DEFAULT SYSUTCDATETIME(),
