...
public class TribeAnnouncementScrollHandlerTests
{
    ...
    [Fact]
    public void Handle_WithCharges_DecrementsCount_SendsSelfUpdate_AndRelaysToSameTribeAcrossZones()
    {
    ...
    [Fact]
    public void Handle_WithNoCharges_Aborts_AndDoesNotBroadcast()
    {
