...
public enum DeathCause
{
    ...
    /// <summary>
    ///     ProcessAttack01/02 (duel or enemy-tribe PvP) -- reward pipeline for the killer is explicitly OUT of scope
    ///     (report 05 §6, ~650-line ProcessForKillOtherTribe); not implemented here.
    /// </summary>
    PlayerKill,

    /// <summary>
    ///     ProcessAttack04 (monster attacks the player) -- the ONLY cause that triggers the XP-loss formula (report 05
    ///     §4, §6).
    /// </summary>
    MonsterKill
}
