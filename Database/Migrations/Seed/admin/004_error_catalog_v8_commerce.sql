...
IF
    ...
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
    VALUES (50274, 'game', N'usp_Gift_ClaimIntoVault: account vault is full (28 slots).');
...
IF
    ...
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
    VALUES (50220, 'game',
            N'usp_Gift_ClaimIntoVault: gift not found, not owned by this account, or already claimed.');
