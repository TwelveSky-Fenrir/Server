...
public class ZcSetHotkeyInventoryRecvTests
{
    ...
    {
        Assert.Equal(28, ZcSetHotkeyInventoryRecv.PayloadSize);
        Assert.Equal(Opcodes.Zone.Outgoing.SetHotkeyInventoryRecv, ZcSetHotkeyInventoryRecv.Opcode);
    }
    ...
    public void Write_MatchesGoldenBytes()
    {
        ...
        var actual = new byte[ZcSetHotkeyInventoryRecv.PayloadSize];
        value.Write(actual);
    ...
    private static ZcSetHotkeyInventoryRecv CreatePopulated()
    {
        return new ZcSetHotkeyInventoryRecv
        {
            Page1 = 11,
            Index1 = 22,
            Page2 = 33,
    ...
    private static void EncodeGolden(Span<byte> destination, ZcSetHotkeyInventoryRecv value)
    {
