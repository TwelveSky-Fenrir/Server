...
/// <summary>Legacy <c>WORLD_REGION_INFO</c> row (STRUCT.h:1327-1335) parsed from <c>*.WREGION.csv</c> under DATA/SUMMON -- the live format (S10_MySummon.cpp); sibling <c>.WREGION</c> binaries are dead code, not read here.</summary>
