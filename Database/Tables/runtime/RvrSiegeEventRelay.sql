...
-- rationale (RvrSiegeEventRelayEntry.CorrelationId is minted once per event and stays stable across
...
(
    ...
    -- Supports usp_RvrSiegeEventRelay_Poll's own time-based reap DELETE -- see
