...
public class ZcMultiItemCreateRecvTests
{
    ...
    {
        Assert.Equal(72, ZcMultiItemCreateRecv.PayloadSize);
        Assert.Equal(Opcodes.Zone.Outgoing.MultiItemCreateRecv, ZcMultiItemCreateRecv.Opcode);
    }
    ...
    public void Write_MatchesGoldenBytes()
    {
        ...
        var actual = new byte[ZcMultiItemCreateRecv.PayloadSize];
        value.Write(actual);
    ...
    private static void AssertFieldsEqual(ZcMultiItemCreateRecv expected, ZcMultiItemCreateRecv actual)
    {
    ...
    private static ZcMultiItemCreateRecv CreatePopulated()
    {
        return new ZcMultiItemCreateRecv
        {
            Num = 11,
            Page = 22,
            Index1 = 33,
    ...
    private static void EncodeGolden(Span<byte> destination, ZcMultiItemCreateRecv value)
    {
