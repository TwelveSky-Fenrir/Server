...
///     Guild state spans every <see cref="World.Zone" /> a member happens to be connected to, so unlike
///     <c>BuffExpirySystem</c> this cannot run as an <see cref="Simulation.ISimulationSystem" />: that contract
