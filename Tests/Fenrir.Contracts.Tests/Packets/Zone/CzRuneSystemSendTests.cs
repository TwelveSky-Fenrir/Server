...
public class CzRuneSystemSendTests
{
    ...
    {
        Assert.Equal(20, CzRuneSystemSend.PayloadSize);
        Assert.Equal(Opcodes.Zone.Incoming.RuneSystemSend, CzRuneSystemSend.Opcode);
    }
    ...
    public void TryRead_GoldenBytes_DecodesEveryField()
    {
        ...
        Assert.True(CzRuneSystemSend.TryRead(golden, out var decoded));
    ...
    {
        Assert.False(CzRuneSystemSend.TryRead(new byte[19], out _));
    }
}
