...
/// </summary>
public sealed class ClLoginMousePasswordSendHandler(IAccountPinRepository pins)
    : IAsyncPacketHandler<ClLoginMousePasswordSend>
{
    ...
    public async ValueTask HandleAsync(ClLoginMousePasswordSend packet, IPacketSession session,
        CancellationToken cancellationToken)
    {
        ...
        {
            session.Send(new LcLoginMousePasswordRecv { Result = 1 });
        ...
        session.Send(new LcLoginMousePasswordRecv { Result = 0 });
    }
}
