...
/// <summary>Raw, unvalidated wire request -- all guard checks, RNG rolls, and HP mutation happen in <c>Zone.ApplyCombatCommand</c> on the zone's own tick thread.</summary>
