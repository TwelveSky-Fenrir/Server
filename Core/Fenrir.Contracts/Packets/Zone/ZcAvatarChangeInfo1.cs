...
///     different layout).
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Outgoing, Opcodes.Zone.Outgoing.AvatarChangeInfo1, ExpectedSize = 25)]
public readonly partial record struct ZcAvatarChangeInfo1 : IOutgoingPacket
{
