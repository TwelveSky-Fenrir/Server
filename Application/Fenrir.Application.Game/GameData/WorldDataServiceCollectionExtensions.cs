...
/// <summary>Cache is resolved through the loader so a consumer that fires before <see cref="WorldDataLoader.InitializeAsync" /> fails loudly instead of reading an empty world.</summary>
