...
/// <summary>
///     In-memory stand-in for <see cref="IGiftRepository" /> -- lets <c>ClGiftInfoSendHandlerTests</c>/
///     <c>ClWantGiftSendHandlerTests</c> drive game.Gifts outcomes (a pending list of any length, a
