...
BEGIN
    ...
    DECLARE @Adjusted TABLE (TribeTransferPermitCount INT);

    UPDATE game.Characters
    SET TribeTransferPermitCount = TribeTransferPermitCount + @Delta,
        UpdatedAtUtc             = SYSUTCDATETIME()
        OUTPUT INSERTED.TribeTransferPermitCount INTO @Adjusted
    ...
    SELECT TribeTransferPermitCount AS NewTribeTransferPermitCount FROM @Adjusted;
END;
