...
public enum WireObfuscationMode : byte
{
    ...
    /// <summary><c>XOR_PACKET(s, sizeof(*s))</c> over the whole buffer, degenerate keystream {0x10, 0xFE, ...}, last byte untouched. §3.1.</summary>
    XorPacketGlobal,

    /// <summary>Field-by-field obfuscation (<c>scopyAvtXor*</c>), opcode stays in clear. Unique to <c>LC_USER_AVATAR_RECV2</c>. §3.2.</summary>
    XorFieldAvatar
}
