...
public class GeneralItemDropResolverTests
{
    ...
    {
        var item = EligibleItem(9001, level: 10, type: Common, sort: Armor);
        var cache = CacheWith(item);
        // sortPool[1] == Armor -- see class remarks on the pool's fixed order.
        var random = new ScriptedRandom(1);

        var result = GeneralItemDropResolver.Resolve(cache, random, killerTribe: 0, itemType: Common, levelLow: 10,
            levelHigh: 10);
    ...
    {
        var item = EligibleItem(9002, level: 10, type: Common, sort: Armor) with { CheckMonsterDrop = 1 };
        var cache = CacheWith(item);
        var random = new ScriptedRandom(1);
    ...
    public void Resolve_TribeRestrictedItem_RejectedForTheWrongTribe()
    {
        ...
        var item = EligibleItem(9003, level: 10, type: Common, sort: Sword, equipInfo1: 3);
        var cache = CacheWith(item);
    ...
    public void Resolve_TribeRestrictedItem_AcceptedForTheRightTribe()
    {
        ...
        var item = EligibleItem(9004, level: 10, type: Common, sort: Sword, equipInfo1: 2);
        var cache = CacheWith(item);
        var random = new ScriptedRandom(5);
    ...
    public void Resolve_NoCandidateAtAll_ReturnsNullWithinAttemptBudget()
    {
        ...
        var cache = CacheWith(EligibleItem(9099, level: 99, type: Common, sort: Armor));
    ...
    {
        var item = EligibleItem(9005, level: 10, type: Common, sort: Armor);
        var cache = CacheWith(item);
        var random = new ScriptedRandom(1);

        var result = GeneralItemDropResolver.Resolve(cache, random, killerTribe: 9, itemType: Common, levelLow: 10,
            levelHigh: 10);
