...
/// <summary>Business logic for CZ_PSHOP_ITEM_INFO_SEND (opcode 34), extracted from <see cref="SearchShopListingsHandler" />.</summary>
public interface ISearchShopListingsService
{
    ...
    /// </summary>
    IReadOnlyList<SearchShopListingsResponse> Search(SearchShopListingsRequest packet, Zone zone);
}
