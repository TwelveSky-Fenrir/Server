...
public sealed record SessionTicketRepository(ICaeriusNetDbContext Db) : ISessionTicketRepository
{
    ...
    public async ValueTask<bool> CreateAsync(int accountId, int characterId, byte shardId,
        ...
        CancellationToken ct)
    {
        ...
        var nonceHash = SessionTicketCapability.CreateHash();
            ...
            for (var attempt = 1;; attempt++)
            {
                var parameters =
                    new StoredProcedureParametersBuilder("runtime", "usp_SessionTicket_Create", 1,
                        ...
                        .AddParameter("CapabilityHash", nonceHash, SqlDbType.Binary)
    ...
    public async ValueTask<ConsumedTicketDto?> ConsumeAsync(int accountId, byte expectedShardId,
