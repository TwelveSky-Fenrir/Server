...
IF NOT EXISTS (SELECT 1 FROM admin.ErrorCatalog WHERE ErrorNumber = 50267)
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
    VALUES (50267, N'game', N'usp_CharacterFriend_Add: friend slot is already occupied.');

IF NOT EXISTS (SELECT 1 FROM admin.ErrorCatalog WHERE ErrorNumber = 50268)
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
...
IF NOT EXISTS (SELECT 1 FROM admin.ErrorCatalog WHERE ErrorNumber = 50269)
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
