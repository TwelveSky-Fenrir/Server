...
/// <summary>
///     Posted after a guild membership change is already durably persisted, to mirror it onto one character's own
///     hosting zone -- a direct field write here would violate the single-writer invariant, since the target may be on a
///     different <see cref="World.Zone" />/tick thread.
/// </summary>
...
/// <param name="Applied">
///     Completed once the tick actually mirrors this command. Null when the caller only needs the DB
///     write's durability, not this specific mirror.
/// </param>
