    ...
    SessionRegistry registry) : IAsyncPacketHandler<ClLoginSend>
{
    ...
    public async ValueTask HandleAsync(ClLoginSend packet, IPacketSession session, CancellationToken cancellationToken)
    {
        ...
        {
            // ClLoginSend.AllowedStates = [Connected, VersionOk]: re-arming VersionOk lets the client retry on
