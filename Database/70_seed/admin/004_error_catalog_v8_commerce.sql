...
IF NOT EXISTS (SELECT 1 FROM admin.ErrorCatalog WHERE ErrorNumber = 50270)
...
IF NOT EXISTS (SELECT 1 FROM admin.ErrorCatalog WHERE ErrorNumber = 50271)
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
...
IF NOT EXISTS (SELECT 1 FROM admin.ErrorCatalog WHERE ErrorNumber = 50272)
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
...
IF NOT EXISTS (SELECT 1 FROM admin.ErrorCatalog WHERE ErrorNumber = 50273)
    INSERT INTO admin.ErrorCatalog (ErrorNumber, SchemaName, Description)
