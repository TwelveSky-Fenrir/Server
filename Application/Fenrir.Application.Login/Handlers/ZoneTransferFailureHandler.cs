...
/// <summary>op23 CL_FAIL_MOVE_ZONE_1_SEND — rolls back to CharSelect, no reply; the stale session ticket needs no explicit revocation (single-use, short TTL).</summary>
