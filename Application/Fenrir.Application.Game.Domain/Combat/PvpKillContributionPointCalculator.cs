...
///     overrides (<c>RegularWar_ProcessKillReward</c>/<c>FFA_ProcessKillReward</c>, S07_MyGame03.cpp:2373-2504).
...
///         formula's additive bonuses only as "one specific server number/tribe combination" (+2), "one
