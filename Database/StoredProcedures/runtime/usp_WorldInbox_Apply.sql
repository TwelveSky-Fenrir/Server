...
BEGIN
    ...
    END
    ELSE IF @DeliveryStatus <> 1 OR @ExistingLeaseId <> @DeliveryLeaseId
    ...
    BEGIN
        ...
        SELECT OutboxId, AuthenticatedSource, SourceShardId, SourceSequence, DestinationShardId, PayloadCategory,
               Payload, PayloadHash, CorrelationId, IdempotencyKey, SYSUTCDATETIME(), NULL
        FROM runtime.WorldOutbox
        WHERE OutboxId = @OutboxId;
