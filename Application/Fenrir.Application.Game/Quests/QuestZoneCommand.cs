...
/// <summary>Posted after a quest-state transition is already durably persisted; Zone's tick mirrors it onto PlayerRuntimeState.</summary>
/// <param name="ExperienceDelta">Flat add to Experience -- the reward value IS the gain, unlike a monster kill's level-gap formula.</param>
