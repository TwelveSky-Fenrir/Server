...
public class ZcHeroRewardRecvTests
{
    ...
    {
        Assert.Equal(56, ZcHeroRewardRecv.PayloadSize);
        Assert.Equal(Opcodes.Zone.Outgoing.HeroRewardRecv, ZcHeroRewardRecv.Opcode);
    }
    ...
    private static ZcHeroRewardRecv CreatePopulated()
    {
        var v = new SequentialValueFactory();
        return new ZcHeroRewardRecv
        {
            Result = 1000,
            Page = v.NextInt(),
            Index1 = v.NextInt(),
    ...
    private static void EncodeGolden(Span<byte> destination, ZcHeroRewardRecv value)
    {
