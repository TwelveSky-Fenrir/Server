...
public class LcDemandGiftRecvTests
{
    ...
    public void PayloadSize_MatchesContractConstant()
    {
        ...
        Assert.Equal(84, LcDemandGiftRecv.PayloadSize);
    }
    ...
    public void RoundTrip_PreservesAllFields()
    {
        ...
        var packet = new LcDemandGiftRecv { Result = 0, GiftItem = giftItem };

        var buffer = new byte[LcDemandGiftRecv.PayloadSize];
        var written = packet.Write(buffer);

        Assert.Equal(LcDemandGiftRecv.PayloadSize, written);
