...
public class ZcAutoConfigRecvTests
{
    ...
    {
        Assert.Equal(12, ZcAutoConfigRecv.PayloadSize);
        Assert.Equal(Opcodes.Zone.Outgoing.AutoConfigRecv, ZcAutoConfigRecv.Opcode);
    }

    [Fact]
    public void Write_MatchesGoldenBytes()
    {
        var value = new ZcAutoConfigRecv { ServerIndex = 3, UniqueNumber = 0xC0FFEEu, AutoState = 1 };
