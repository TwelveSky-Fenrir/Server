...
/// </summary>
[FenrirPacket(FenrirServer.Login, FenrirDirection.Incoming, Opcodes.Login.Incoming.FailMoveZone1Send,
    ExpectedSize = 9, AllowedStates = [(byte)LoginSessionState.HandoverIssued])]
public readonly partial record struct ClFailMoveZone1Send : IIncomingPacket<ClFailMoveZone1Send>
{
}
