...
public enum ZoneWarKind : byte
{
    ...
    /// <summary>ZC 194_TYPE_BATTLE_INFO/COUNTDOWN (op100/101) -- BattleInfo[4] + RemainTime, plus its own lighter countdown frame.</summary>
    Zone194 = 2,
...
///         same "real API, not yet called by anything" posture as <see cref="Progression.TowerWarState" />.
...
public sealed class ZoneWarTickService(ZoneRegistry zones) : BackgroundService
{
    ...
    /// <summary>Feeds Zone051/194/267's per-tribe standings array (ExistStone/BattleInfo) -- Zone049 ignores this, see remarks.</summary>
