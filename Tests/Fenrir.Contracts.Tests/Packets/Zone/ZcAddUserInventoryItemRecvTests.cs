...
public class ZcAddUserInventoryItemRecvTests
{
    ...
    {
        Assert.Equal(48, ZcAddUserInventoryItemRecv.PayloadSize);
        Assert.Equal(Opcodes.Zone.Outgoing.AddUserInventoryItemRecv, ZcAddUserInventoryItemRecv.Opcode);
    }
    ...
    public void Write_MatchesGoldenBytes()
    {
        ...
        var actual = new byte[ZcAddUserInventoryItemRecv.PayloadSize];
        value.Write(actual);
    ...
    private static void AssertFieldsEqual(ZcAddUserInventoryItemRecv expected, ZcAddUserInventoryItemRecv actual)
    {
    ...
    private static ZcAddUserInventoryItemRecv CreatePopulated()
    {
        return new ZcAddUserInventoryItemRecv
        {
            Result = 11,
            ItemIndex = 22,
            Page = 33,
    ...
    private static void EncodeGolden(Span<byte> destination, ZcAddUserInventoryItemRecv value)
    {
