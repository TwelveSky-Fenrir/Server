...
(
    ...
    KillOtherTribeCount  INT          NOT NULL
        CONSTRAINT DF_TribeVotes_KillOtherTribeCount DEFAULT 0,
    VotePoint            INT          NOT NULL
        CONSTRAINT DF_TribeVotes_VotePoint DEFAULT 0,
    RegisteredAtUtc      DATETIME2(3) NOT NULL
        CONSTRAINT DF_TribeVotes_RegisteredAtUtc DEFAULT SYSUTCDATETIME(),
