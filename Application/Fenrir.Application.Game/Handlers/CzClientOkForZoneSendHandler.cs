...
/// </summary>
public sealed class CzClientOkForZoneSendHandler : IInlinePacketHandler<CzClientOkForZoneSend>
{
    public void Handle(in CzClientOkForZoneSend packet, IPacketSession session)
    {
