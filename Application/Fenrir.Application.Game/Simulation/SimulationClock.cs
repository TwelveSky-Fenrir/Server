...
///     whole legacy ticks delivered by <see cref="SimulationTickAccumulator" />, converted through THIS constant and
///     nothing else.
/// </summary>
/// <remarks>
...
public static class SimulationClock
{
    ...
    ///     discarded (callers that must not lose it accumulate through <see cref="SimulationTickAccumulator" />).
    /// </summary>
