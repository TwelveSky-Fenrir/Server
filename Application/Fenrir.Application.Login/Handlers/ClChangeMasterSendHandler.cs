...
/// </summary>
public sealed class ClChangeMasterSendHandler : IInlinePacketHandler<ClChangeMasterSend>
{
    public void Handle(in ClChangeMasterSend packet, IPacketSession session)
    {
