...
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Incoming, Opcodes.Zone.Incoming.SetDeputyPshopMoneySend,
    ExpectedSize = 17, AllowedStates = [(byte)ZoneSessionState.InWorld])]
public readonly partial record struct CzSetDeputyPshopMoneySend : IIncomingPacket<CzSetDeputyPshopMoneySend>
{
