...
public class CzRegisterAvatarSendTests
{
    ...
    public void PayloadSize_MatchesContract()
    {
        ...
        Assert.Equal(Opcodes.Zone.Incoming.EnterWorld, EnterWorldRequest.Opcode);
    }
    ...
    public void TryRead_DecodesGoldenBytes()
    {
        ...
        Span<byte> buffer = new byte[EnterWorldRequest.PayloadSize];
        ...
        Assert.Equal(268 + ActionInfo.WireSize, EnterWorldRequest.PayloadSize);

        var ok = EnterWorldRequest.TryRead(buffer, out var packet);
