...
public class ZcAvatarActionRecvTests
{
    ...
    public void PayloadSize_MatchesContract()
    {
        ...
        Assert.Equal(4 + 4 + ObjectForAvatar.WireSize + 4, ZcAvatarActionRecv.PayloadSize);
        Assert.Equal(Opcodes.Zone.Outgoing.AvatarActionRecv, ZcAvatarActionRecv.Opcode);
    }
    ...
    public void Write_RoundTrips_ViaManualOffsetRead()
    {
        ...
        Span<byte> buffer = new byte[ZcAvatarActionRecv.PayloadSize];
        var written = packet.Write(buffer);

        Assert.Equal(ZcAvatarActionRecv.PayloadSize, written);
    ...
    public void Write_ProducesGoldenBytes()
    {
        ...
        var golden = new byte[ZcAvatarActionRecv.PayloadSize];
