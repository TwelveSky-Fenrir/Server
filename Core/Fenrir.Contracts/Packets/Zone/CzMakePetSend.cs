...
/// <summary>
///     CZ_MAKE_PET_SEND (CLIENT.h:289) — same typedef as <see cref="CzMakeItemSend" /> (29). Pet
...
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Incoming, Opcodes.Zone.Incoming.MakePetSend, ExpectedSize = 45,
    AllowedStates = [(byte)ZoneSessionState.InWorld])]
public readonly partial record struct CzMakePetSend : IIncomingPacket<CzMakePetSend>
{
