...
public class ZcDrunkInfoRecvTests
{
    ...
    {
        Assert.Equal(12, ZcDrunkInfoRecv.PayloadSize);
        Assert.Equal(Opcodes.Zone.Outgoing.DrunkInfoRecv, ZcDrunkInfoRecv.Opcode);
    }

    [Fact]
    public void Write_MatchesGoldenBytes()
    {
        var value = new ZcDrunkInfoRecv { Sort = 1, Result = 0, BottleIndex = 3 };
