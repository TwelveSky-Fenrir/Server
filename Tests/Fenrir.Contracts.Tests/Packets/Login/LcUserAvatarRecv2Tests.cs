...
public class LcUserAvatarRecv2Tests
{
    ...
    public void PayloadSize_MatchesContractConstant()
    {
        ...
        Assert.Equal(4578, LcUserAvatarRecv2.PayloadSize);
    }
    ...
    public void RoundTrip_PreservesAllFields_ThroughPerFieldAvatarXor()
    {
        ...
        var packet = new LcUserAvatarRecv2
        {
            VisibleState = 1,
            SpecialState = 2,
            CostumeIndex = 3,
        ...
        var buffer = new byte[LcUserAvatarRecv2.PayloadSize];
        var written = packet.Write(buffer);

        Assert.Equal(LcUserAvatarRecv2.PayloadSize, written);
