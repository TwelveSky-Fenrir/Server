...
/// <summary>
///     Byte vectors hand-built from offsets in <c>Docs/protocol/M1_Legacy_Wire_Contract.md</c>
///     (NOT generated by the <c>Write</c>/<c>TryRead</c> under test) for the 6 most critical M1 packets (§6.3).
/// </summary>
public class GoldenBytesTests
{
    ...
    {
        // §3.10/§4.3: ServerIndex int@0, UniqueNumber uint@4, Data OBJECT_FOR_AVATAR@8 (632 bytes),
        // CheckChangeActionState int@640. Payload = 4+4+632+4 = 644 bytes. OBJECT_FOR_AVATAR has five
        // 3-byte padding gaps at internal offsets 29, 41, 61, 489, 533 (§7.3).
