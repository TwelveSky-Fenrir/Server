...
-- via INSERT if the character has no row yet for that period. TribeId is refreshed opportunistically
-- (COALESCE keeps the previously stored value when NULL is passed).
--
