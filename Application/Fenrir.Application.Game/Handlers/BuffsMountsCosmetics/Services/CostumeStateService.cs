...
{
    ValueTask<CostumeStateResult> ApplyAsync(Zone zone, PlayerRuntimeState state, int characterId, int sort,
    ...
    ILogger<CostumeStateService> logger) : ICostumeStateService
{
        ...
        int sort, int value, CancellationToken cancellationToken)
    {
        ...
        switch (result.Kind)
        {
            ...
            case CostumeStateResolver.ResultKind.Select:
                ...
                return new CostumeStateResult(CostumeStateOutcome.Reply, ResultCode: 0);
            ...
            case CostumeStateResolver.ResultKind.ReturnToInventoryMismatch:
                return new CostumeStateResult(CostumeStateOutcome.Reply, ResultCode: 1);
        ...
        int characterId, CostumeStateResolver.Result result, CancellationToken cancellationToken)
    {
        if (!worldData.ItemsById.TryGetValue(result.GrantedItemId, out _))
            return new CostumeStateResult(CostumeStateOutcome.Reply, ResultCode: 2);
        ...
        return new CostumeStateResult(CostumeStateOutcome.Reply, ResultCode: 0, Page: destination.Container,
