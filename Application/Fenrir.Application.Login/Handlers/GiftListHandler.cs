...
/// <summary>op25 CL_GIFT_INFO_SEND — first 10 pending gifts (oldest-first), [i][0]=ProductId,[i][1]=0 matching legacy uGiftInfo shape; 11th+ still claimable once the list shifts.</summary>
