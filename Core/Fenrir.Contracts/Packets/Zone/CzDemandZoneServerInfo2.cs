...
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Incoming, Opcodes.Zone.Incoming.DemandZoneServerInfo2,
    ExpectedSize = 21, AllowedStates = [(byte)ZoneSessionState.InWorld])]
public readonly partial record struct CzDemandZoneServerInfo2 : IIncomingPacket<CzDemandZoneServerInfo2>
{
    /// <summary>
