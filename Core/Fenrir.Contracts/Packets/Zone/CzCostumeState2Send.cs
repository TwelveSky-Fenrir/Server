...
///     Broadcast11).
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Incoming, Opcodes.Zone.Incoming.CostumeState2Send,
    ExpectedSize = 13, AllowedStates = [(byte)ZoneSessionState.InWorld])]
public readonly partial record struct CzCostumeState2Send : IIncomingPacket<CzCostumeState2Send>
{
