...
/// <summary>CZ_FRIEND_ANSWER_SEND (opcode 55). 0 = accept, 1/2 = refuse, else ignored. On accept, BOTH sides become eligible to call their own CZ_FRIEND_MAKE_SEND (<see cref="FriendRegistry.TryConsumeAccepted" />) -- neither side is automatically added.</summary>
public sealed class FriendAnswerHandler(ZoneRegistry zones, FriendRegistry friends) : IInlinePacketHandler<FriendAnswerRequest>
{
