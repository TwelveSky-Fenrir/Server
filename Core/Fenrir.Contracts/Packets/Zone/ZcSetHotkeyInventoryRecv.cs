...
///     request).
/// </summary>
[FenrirPacket(FenrirServer.Zone, FenrirDirection.Outgoing, Opcodes.Zone.Outgoing.SetHotkeyInventoryRecv,
    ExpectedSize = 29)]
public readonly partial record struct ZcSetHotkeyInventoryRecv : IOutgoingPacket
{
