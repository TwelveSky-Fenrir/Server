...
public class LcLoginConnectOkRecvTests
{
    ...
    {
        // ExpectedSize=37 (1-byte outbound header + tPad0..tPad4 20 bytes + 3 int 4 bytes = 36-byte payload).
    ...
    public void Write_ReservedPadding_IsZeroed()
    {
        ...
        var buffer = new byte[LcLoginConnectOkRecv.PayloadSize];
        packet.Write(buffer);
    ...
    public void RoundTrip_PreservesAllFields()
    {
        ...
        Assert.Equal(LcLoginConnectOkRecv.PayloadSize, written);
